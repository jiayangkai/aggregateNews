<template lang="html">
  <div>
    <div class="header">
      <img :src="backImg" @click="backPersonal">
      <span>我的收藏</span>
      <span></span>
    </div>
    <slide class="slide" :dataList="collectionNews" :dataType="0"></slide>
    <!-- <div class="content">
        ...
        <div class="section" @click="toDetailNews(item,index)">
          ...
          <div class="news-right">
            ...
            <div class="news-message">
              <span>{{item.time || '2018-06-12'}}</span>
...
<script>
  ...
  export default {
    ...
    methods: {
      ...
      toDetailNews(param) {
        this.$store.state.channelNew = param
